...
params=[(.707,0,0,1000,.99,10,100,8,1.0,8,1.0),
        ...
        (.707, 0, 0, 1000, .99, 100, 100, 8, 1.0, 8, 1.0),
        (.588, 0, 0, 1000, .99, 100, 100, 8, 1.0, 8, 1.0),
        (.951, -.4, 0, 1000, .99, 100, 100, 8, 1.0, 8, 1.0),
        (.707, -1, -1, 1000, .99, 100, 100, 8, 1.0, 8, 1.0),
        (.588, -1, -1, 1000, .99, 100, 100, 8, 1.0, 8, 1.0),
        (.951, -1, -1, 1000, .99, 100, 100, 8, 1.0, 8, 1.0),

        (.707, 0, 0, 1000, .99, 100, 100, 8, 1.0, 8, .125),
        ]
